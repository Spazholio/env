...
plugins=(z git sudo zsh-completions zsh-autosuggestions colored-man-pages cp jsontools nmap rsync ssh-agent zsh-interactive-cd zsh_reload autoupdate extract zsh-syntax-highlighting docker)
