...
plugins=(git sudo zsh-completions zsh-autosuggestions zsh-syntax-highlighting colored-man-pages cp jsontools nmap rsync ssh-agent zsh-interactive-cd zsh_reload autoupdate)
